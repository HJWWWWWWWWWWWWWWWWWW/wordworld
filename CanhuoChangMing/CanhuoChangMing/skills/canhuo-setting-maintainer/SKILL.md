...
- 新增重大牺牲必须在叙事中交代人物知道多少、是否真有拒绝余地以及谁从中受益；不要求人物把这些内容全部登记成文，记录只在职业、罪证或防止姓名被抹去时出现。
- 新增遗物不得成为无代价万能解法。
- 新增州名先判断是行政州、旧称、地理区还是军区；不得扩出第十三州。
- 角色只能知道亲历、被告知或从档案读取的信息。
- 不确定时保留异议与无法确认，不为整齐结论虚构答案。
- 大燧基层官署、矿商、宗门与司灯台对百姓以压制和维稳为先，不能默认耐心解释、平等协商或尊重拒绝；少数善意是例外且要付出代价。
- 正文不得把日常对话与互助普遍写成登记、按印、见证、逐句确认。铁匠生意账、医馆药账、官署命令、重大灾情、死者姓名与核心罪证可以保留，其他关系主要靠行动、记忆和口头承诺呈现。
- 外部世界采用黑暗中带微光的基调；林家与主角团内部允许温暖、轻松和互相拆台，让希望来自具体关系而非压迫机构。
