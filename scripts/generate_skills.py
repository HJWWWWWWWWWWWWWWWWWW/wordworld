...
# ═══════════════════════════════════════════════════════════════════
HEAVENLY_FLAMES = [
    (1,  "帝炎",           "divine",   "古帝的本命火焰，异火榜第一，可焚尽万物。"),
    (2,  "虚无吞炎",       "divine",   "异火榜第二，可吞噬一切化为虚无，诞生灵智。"),
    (3,  "净莲妖火",       "emperor",  "异火榜第三，可净化万物杂质，妖莲形态。"),
    (4,  "金帝焚天炎",     "emperor",  "异火榜第四，古族传承之火，金光焚天。"),
    (5,  "生灵之焱",       "saint",    "异火榜第五，蕴含磅礴生机，火焰如生命之树。"),
    (6,  "八荒破灭焱",     "saint",    "异火榜第六，可破灭八方，毁灭之力。"),
    (7,  "九幽金祖火",     "mystic",   "异火榜第七，九幽之下孕育的金色火焰。"),
    (8,  "红莲业火",       "mystic",   "异火榜第八，业火焚罪、红莲净世。"),
    (9,  "三千焱炎火",     "heaven",   "异火榜第九，又名三千星空焱炎火。"),
    (10, "九幽风炎",       "heaven",   "异火榜第十，风炎交融的奇火。"),
    (11, "骨灵冷火",       "earth",    "异火榜第十一，药老的本命火焰，极寒之焰。"),
    (12, "九龙雷罡火",     "earth",    "异火榜第十二，九龙环绕、雷火齐鸣。"),
    (13, "龟灵地火",       "treasure", "异火榜第十三，地心孕育的龟形火焰。"),
    (14, "陨落心炎",       "treasure", "异火榜第十四，透明无色、直攻内心。"),
    (15, "海心焰",         "spirit",   "异火榜第十五，深海之心孕育的奇焰。"),
    (16, "火山石焰",       "spirit",   "异火榜第十六，火山口万年不灭的暗红火焰。"),
    (17, "风雷怒焱",       "spirit",   "异火榜第十七，风雷交加而成的紫青火焰。"),
    (18, "青莲地心火",     "refined",  "异火榜第十八，萧炎获得的第一种异火。"),
    (19, "龙凤焱",         "refined",  "异火榜第十九，龙血凤骨诞生的双色火焰。"),
    (20, "六道轮回焱",     "iron",     "异火榜第二十，传说来自六道轮回。"),
    (21, "万兽灵火",       "iron",     "异火榜第二十一，万兽灵魂燃烧的火焰。"),
    (22, "玄黄炎",         "iron",     "异火榜第二十二，玄黄之气凝聚而成。"),
    (23, "幽冥毒火",       "iron",     "异火榜第二十三，蕴含剧毒的诡异绿焰。"),
]
...
TECHNIQUE_TEMPLATES = {
    "火": [
        ("焚天诀","atk:+8,fire_power:+15%","以烈焰斗气强化火属性攻击力。"),
        ...
        ("离火归元诀","douqi_max:+30,fire_power:+12%","离火归元，斗气上限大增。"),
        ("火凤涅槃经","hp:+60,revive_chance:+5%","火凤涅槃，低概率自动复活。"),
        ("烈焰金身功","def:+12,thorns:10","烈焰护体金身，反弹10%伤害。"),
        ("丹火养气法","douqi_max:+40,douqi_regen:+5","丹火养气，斗气自生不息。"),
    ...
    "冰": [
        ...
        ("太阴寒月法","douqi_max:+35,ice_power:+15%","太阴月华，斗气与寒冰双修。"),
    ...
    "雷": [
        ...
        ("雷元归一功","douqi_max:+30,thunder_power:+12%","雷元归一，斗气上限大增。"),
    ...
    "木": [
        ...
        ("森林之息法","douqi_max:+40,wood_power:+12%","森林吐息，斗气上限大增。"),
    ...
    "土": [
        ...
        ("矿脉吸灵功","douqi_max:+30,earth_power:+12%","矿脉吸灵，斗气与土攻。"),
        ...
        ("大地归元功","douqi_max:+50,earth_power:+15%","大地归元，斗气与土攻。"),
    ...
    "毒": [
        ...
        ("毒元归一功","douqi_max:+35,poison_power:+12%","毒元归一，斗气大增。"),
...
ELEMENT_SKILLS = {
    "火": [
        ...
        ("skill_fire_26","焚诀·吞噬",48,35,"以焚决催动吞噬异火之力。"),
    ...
    "木": [
        ...
        ("skill_wood_10","森林之息",8,12,"森林吐息恢复HP和斗气。"),
...
# 通用/辅助技能 40个
UTILITY_SKILLS = [
    ("skill_util_1","恢复术",0,8,"消耗斗气恢复生命。","heal:60"),
    ...
    ("skill_util_5","回气术",0,10,"恢复斗气的法门。","douqi_restore:80"),
    ("skill_util_6","聚气归元",0,20,"大量恢复斗气。","douqi_restore:200"),
    ("skill_util_7","斗气泉涌",0,35,"斗气如泉涌般恢复。","douqi_restore:500"),
    ("skill_util_8","净化术",0,8,"驱散负面状态。","cleanse"),
    ("skill_util_9","护盾术",0,12,"生成斗气护盾吸收伤害。","shield:150"),
    ...
    ("skill_util_20","冥想",0,5,"进入冥想恢复HP和斗气。","heal:30,douqi_restore:30"),
    ("skill_util_21","急救",0,5,"快速包扎恢复少量生命。","heal:40"),
    ("skill_util_22","气疗术",0,8,"斗气温养经脉。","heal:80,douqi_restore:20"),
    ...
    ("skill_util_29","斗气燃烧",0,10,"燃烧斗气换取攻击提升。","douqi_to_atk:50"),
    ("skill_util_30","牺牲",0,5,"消耗生命换取大量斗气。","hp_to_douqi:100"),
    ("skill_util_31","灵魂链接",0,20,"链接灵魂恢复生命和斗气。","heal:200,douqi_restore:100"),
    ("skill_util_32","时空扭曲",0,30,"扭曲时空获得额外回合。","extra_turn"),
    ("skill_util_33","封印术",0,18,"封印敌人技能一回合。","seal:1"),
    ("skill_util_34","吸星大法",0,22,"吸取敌人斗气为己用。","douqi_drain:100"),
...
def generate_all() -> Dict[str, Any]:
    ...
    for rank, name, tier, desc in HEAVENLY_FLAMES:
        ...
        flames.append({"id":fid,"name":name,"type":"heavenly_flame","tier":tier,
                        "effect":"special","desc":f"异火榜第{rank}。{desc}",
