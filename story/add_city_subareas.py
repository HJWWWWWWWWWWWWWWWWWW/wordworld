...
NEW_SUB_MAPS = [
    ...
    ("map_stone_mo_mercenary", "石漠城佣兵大厅", "石漠城", "", 7, 4, "yes", "",
     "石漠城佣兵任务发布与结算的中心，木制柜台后排满了等候接取悬赏的斗者。青鳞在此被人刁难。",
     "青鳞剧情关键节点"),
    ...
    ("map_black_seal_auction", "黑印城拍卖行", "黑印城", "", 20, 5, "yes", "",
     "八扇门掌控的地下拍卖场，黑角域最隐秘的交易盛会。珍品功法、禁药与高阶魔核在此轮番登场。",
     "黑角域拍卖核心"),
    ...
    # ── 魔炎谷 ──
    ("map_demon_valley_hall", "魔炎谷大殿", "魔炎谷", "", 36, 8, "no", "",
     "方言三老议事的大殿，谷中毒火从地缝中渗出。殿内悬着历代谷主的画像，阴森中透着一股邪气。",
     "魔炎谷核心"),
    ("map_demon_valley_archive", "魔炎谷藏功阁", "魔炎谷", "", 36, 6, "no", "",
     "存放魔炎谷百年积累的功法斗技与韩枫炼药笔记的石阁。禁制森严，擅闯者遭毒火反噬。",
     "魔炎谷功法"),
    ...
    ("map_sky_demon_hall", "天冥宗冥殿", "天冥宗", "", 42, 8, "no", "",
     "宗主与长老议事之所，冥气化为实质在殿中流转。殿中幽暗的光线下，隐约可见魂殿护法的身影。",
     "天冥宗核心"),

    # ── 天罡殿 ──
    ("map_heavenly_gang_prison", "天罡殿魂牢", "天罡殿", "", 62, 10, "no", "",
     "囚禁被收集灵魂体的阴冷牢狱，铁链拖曳声与灵魂哀嚎不绝于耳。药老曾被囚于此。",
     "魂殿囚牢"),
    ("map_heavenly_gang_origin", "天罡殿本源殿", "天罡殿", "", 63, 10, "no", "",
     "魂殿囤积灵魂本源的秘殿，殿中央的灵魂井深不见底。魂灭生在此抽取本源之力强化自身。",
     "魂殿本源"),
]
...
NEW_ENCOUNTERS = [
    ...
    enc("enc_black_rock_black_2", "map_black_rock_black_market",
        "暗巷中两个身影低声交谈，隐约听到「云岚宗」和「魂殿」的字眼。其中一人袖口绣着陌生的标志。",
        "暗中偷听", "soul:+5",
        "跟踪可疑人物", "exp:+30"),
    ...
    enc("enc_tianya_wormhole_1", "map_tianya_wormhole_square",
        "虫洞出口光芒大盛，一位刚从虫洞中踏出的斗尊强者面色苍白地扶墙喘息。罗家护卫立刻上前递上恢复丹药。",
        "向斗尊请教中州见闻", "soul:+3",
        "观察虫洞运转", "soul:+2"),
    ...
    enc("enc_tianya_inn_1", "map_tianya_inn",
        "客栈大堂里聚满了因虫洞维修而滞留的旅人。一个自称曾在中州四方阁修炼过的中年斗者正在高谈阔论。",
    ...
    enc("enc_black_seal_auction_1", "map_black_seal_auction",
        "八扇门的地下拍卖厅座无虚席。今晚的压轴拍品是一卷地阶斗技残卷，起拍价已让大半在场者倒吸一口凉气。",
    ...
    enc("enc_sky_demon_hall_1", "map_sky_demon_hall",
        "殿中冥气流转，宗主与魂殿护法的密谈正在进行。你的闯入让两人同时转头，目光中杀意凛然。",
        "正面质问勾结魂殿之事", "exp:+150,reputation:+10",
        "暗中收集证据", "soul:+8"),

    # ── 天罡殿魂牢 ──
    enc("enc_heavenly_gang_prison_1", "map_heavenly_gang_prison",
        "魂牢中铁链拖曳声此起彼伏，数百个灵魂体被锁在特制的魂锁中。其中一个苍老的灵魂体让你心头一颤——那是药老被囚的位置。",
