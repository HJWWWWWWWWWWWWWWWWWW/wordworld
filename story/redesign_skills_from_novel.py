...
NOVEL_SKILLS = [
    # ── 林烬灵技（玩家可用，已有）──
    # 八荒崩、焰分噬浪尺、佛怒火莲、帝印决(开山/翻海/覆地/湮天/古帝)
    ...
    ("skill_sword_qi", "剑气", "剑技", "黄阶高级", "atk:+18",
     "以灵力凝聚剑芒远程攻击。各宗弟子的基础技能。",
     "原文常见描述"),
    ("skill_palm_strike", "掌法", "物理", "黄阶中级", "atk:+14",
     "凝聚灵力于掌心的基础攻击。",
     "原文常见描述"),
    ("skill_body_fortify", "灵力护体", "防御", "黄阶高级", "def:+20",
     "以灵力强化身体防御。所有修炼者皆会的基础技能。",
     "原文常见描述"),

    # ── 源火能力 ──
    ("skill_green_lotus_burn", "青莲焚天", "源火", "地阶高级", "atk:+70,soul:+15",
     "青莲源火全力爆发。林烬的招牌杀招之一。",
     "原文青莲源火"),
    ("skill_fallen_heart_pulse", "心炎脉冲", "源火", "地阶高级", "atk:+65,soul:+15",
     "陨心源火脉冲灼烧灵魂。天焚炼气塔中陨心源火的攻击方式。",
     "原文陨心源火"),
    ("skill_sea_flame_tide", "海心焰·焚海", "源火", "地阶高级", "atk:+75,spd:+10",
     "冷煜以海心焰发动的全力一击。",
     "原文海心焰"),
    ("skill_purifying_saint", "净莲净化", "源火", "天阶中级", "atk:+90,soul:+30",
     "净世白莲火以净化之力焚毁万物。净莲妖圣残魂的守护之力。",
     "原文净世白莲火"),
    ("skill_three_thousand_star", "三千星焱", "源火", "天阶低级", "atk:+80,soul:+20",
     "三千星空火的星空之力。星域守护者的力量源泉。",
     "原文三千星空火"),
    ("skill_gold_emperor_burn", "金帝焚天", "源火", "天阶中级", "atk:+100,soul:+40",
     "金乌焚天火全力爆发。萧云曦的本命源火。",
     "原文金乌焚天火"),
    ("skill_nihility_swallow", "虚无吞灭", "源火", "天阶高级", "atk:+150,soul:+80",
     "虚无吞炎的终极形态——吞噬一切。玄族镇族源火。",
     "原文虚无吞炎"),
    ("skill_emperor_unity_flame", "帝炎·万火归一", "源火", "帝阶", "atk:+300,soul:+100",
     "源帝融合二十二种源火形成的万火归一。",
     "原文帝炎"),

    # ── 远古种族 ──
    ("skill_bloodline_pressure", "血脉压制", "远古", "地阶高级", "atk:+50,spd:-15",
     "远古种族以血脉等级压制对手。云族、玄族等远古种族的共同能力。",
     "原文血脉压制"),
    ...
    ("skill_fire_poison_dual", "火毒双修", "秘法", "地阶低级", "atk:+55,poison:+15",
     "魔焰谷方言三老的火毒双修功法。火与毒融合的诡异攻击。",
     "原文方言"),
    ("skill_demon_fire_array", "魔火焚天阵", "火系", "地阶中级", "atk:+80",
     "魔焰谷护谷大阵，以魔火焚尽入阵者。方言三老可联手催动。",
     "原文魔焰谷"),
]
...
def mob_skills_by_type(eid, name, level):
    ...
    basics = []
    if lv >= 5:
        basics.append("skill_body_fortify")  # 灵力护体 - 所有修炼者都会
    if lv >= 12:
