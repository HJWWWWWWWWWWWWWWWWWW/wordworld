...
scan_chars = [
    ...
    "魂天帝", "虚无吞炎",
    "古元", "古烈", "古青阳", "古华", "古刑", "古妖", "古真", "古南海",
    "炎烬", "雷赢",
    "药丹", "药万归", "药星极",
    "烛坤", "北龙王", "南龙王", "西龙王", "黑擎",
    "萧炎", "萧战", "萧鼎", "萧厉", "萧潇", "萧玄", "萧晨",
    "薰儿", "纳兰嫣然", "纳兰桀", "纳兰肃",
    "米特尔腾山", "木辰", "木战",
    "严狮", "风黎", "丘陵",
    "骛护法", "摘星老鬼",
...
output.append("\n\n### 缺失斗技/功法扫描:")
scan_skills = [
    "八极崩", "焰分噬浪尺", "佛怒火莲", "帝印决", "五轮离火法",
    "天火三玄变", "金刚琉璃体", "大天造化掌", "黄泉天怒", "黄泉掌", "黄泉指",
    "三千雷动", "三千雷幻身", "风之极", "风之极陨杀", "风推势",
    "吸掌", "吹火掌", "狮山裂", "狂狮怒罡", "狂狮吟",
    "六合游身尺", "覆地印", "湮天印", "开山印", "翻海印",
    "古帝印", "毁灭火体", "龙凰古甲", "太虚古龙之力",
    "金帝焚天炎", "青莲地心火", "陨落心炎", "净莲妖火", "三千焱炎火",
    "骨灵冷火", "海心焰", "玄黄炎", "万兽灵火", "八荒破灭焱",
    "九幽金祖火", "红莲业火", "九幽风炎", "火云水炎", "龟灵地火", "火山石焰",
    "生灵之焱", "虚无吞炎",
    "紫云翼", "碧蛇三花瞳", "厄难毒体",
    "焚诀", "血宗秘法", "魂族秘法", "花宗秘法", "蛇人封印术",
    "魂手印", "魂锁", "魂帝秘法",
    "萧族族纹", "联盟号令",
    "绝世好剑",  # joke
    "大寂灭指", "黄泉指",
